/****************************************************************************
 * boards/risc-v/hpmicro/hpm6300evk-sdk/src/hpm6300_i2c.c
 *
...
/****************************************************************************
 * Name: hpm6300_i2cbus_pins_initialize
 *
 * Description:
...
int hpm6300_i2cbus_pins_initialize(int port)
{
...
/****************************************************************************
 * Name: hpm6300evk_i2cdev_initialize
 *
 * Description:
...
int hpm6300evk_i2cdev_initialize(uint8_t port)
{
  int ret = ERROR;
  ...
  if (g_i2c0_dev == NULL)
    {
      syslog(LOG_ERR, "ERROR: hpm6300_i2cbus_initialize(0) failed: %d\n",
             ret);
      ret = -ENODEV;
    }
  else
