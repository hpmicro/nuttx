...
typedef struct {
    ...
    union {
        __RW uint32_t CMP[16];                 /* 0xC - 0x48: Comparator register */
        __RW uint32_t CMP_HRPWM[16];           /* 0xC - 0x48: Comparator register */
    };
    __R  uint8_t  RESERVED0[44];               /* 0x4C - 0x77: Reserved */
    __RW uint32_t FRCMD;                       /* 0x78: Force output mode register */
    __RW uint32_t SHLK;                        /* 0x7C: Shadow registers lock register */
    __RW uint32_t CHCFG[16];                   /* 0x80 - 0xBC: Output channel configure register */
    __R  uint8_t  RESERVED1[48];               /* 0xC0 - 0xEF: Reserved */
    ...
    __R  uint32_t CAPPOS[16];                  /* 0x100 - 0x13C: Capture rising edge register */
    __R  uint8_t  RESERVED3[48];               /* 0x140 - 0x16F: Reserved */
    __R  uint32_t CNT;                         /* 0x170: Counter */
    __R  uint8_t  RESERVED4[12];               /* 0x174 - 0x17F: Reserved */
    __R  uint32_t CAPNEG[16];                  /* 0x180 - 0x1BC: Capture falling edge register */
    __R  uint8_t  RESERVED5[48];               /* 0x1C0 - 0x1EF: Reserved */
