...
typedef struct {
    ...
    __R  uint32_t PHY_STATUS[1];               /* 0x10: LVDS TX PHY Status register */
 ...
 */
#define LVB_CONTROL_SPLIT_CH_REVERSE_MASK (0x8000000UL)
#define LVB_CONTROL_SPLIT_CH_REVERSE_SHIFT (27U)
#define LVB_CONTROL_SPLIT_CH_REVERSE_SET(x) (((uint32_t)(x) << LVB_CONTROL_SPLIT_CH_REVERSE_SHIFT) & LVB_CONTROL_SPLIT_CH_REVERSE_MASK)
#define LVB_CONTROL_SPLIT_CH_REVERSE_GET(x) (((uint32_t)(x) & LVB_CONTROL_SPLIT_CH_REVERSE_MASK) >> LVB_CONTROL_SPLIT_CH_REVERSE_SHIFT)
 ...
 */
#define LVB_CONTROL_SPLIT_CH_MODE_MASK (0x4000000UL)
#define LVB_CONTROL_SPLIT_CH_MODE_SHIFT (26U)
#define LVB_CONTROL_SPLIT_CH_MODE_SET(x) (((uint32_t)(x) << LVB_CONTROL_SPLIT_CH_MODE_SHIFT) & LVB_CONTROL_SPLIT_CH_MODE_MASK)
#define LVB_CONTROL_SPLIT_CH_MODE_GET(x) (((uint32_t)(x) & LVB_CONTROL_SPLIT_CH_MODE_MASK) >> LVB_CONTROL_SPLIT_CH_MODE_SHIFT)
 ...
 * 0: no
 */
#define LVB_CONTROL_SPLIT_HSWHBP_WIDTH_MASK (0x2000000UL)
#define LVB_CONTROL_SPLIT_HSWHBP_WIDTH_SHIFT (25U)
#define LVB_CONTROL_SPLIT_HSWHBP_WIDTH_SET(x) (((uint32_t)(x) << LVB_CONTROL_SPLIT_HSWHBP_WIDTH_SHIFT) & LVB_CONTROL_SPLIT_HSWHBP_WIDTH_MASK)
#define LVB_CONTROL_SPLIT_HSWHBP_WIDTH_GET(x) (((uint32_t)(x) & LVB_CONTROL_SPLIT_HSWHBP_WIDTH_MASK) >> LVB_CONTROL_SPLIT_HSWHBP_WIDTH_SHIFT)
 ...
 */
#define LVB_CONTROL_SPLIT_MODE_EN_MASK (0x1000000UL)
#define LVB_CONTROL_SPLIT_MODE_EN_SHIFT (24U)
#define LVB_CONTROL_SPLIT_MODE_EN_SET(x) (((uint32_t)(x) << LVB_CONTROL_SPLIT_MODE_EN_SHIFT) & LVB_CONTROL_SPLIT_MODE_EN_MASK)
#define LVB_CONTROL_SPLIT_MODE_EN_GET(x) (((uint32_t)(x) & LVB_CONTROL_SPLIT_MODE_EN_MASK) >> LVB_CONTROL_SPLIT_MODE_EN_SHIFT)
 ...
 * 0: active high
 */
#define LVB_CONTROL_DI1_VSYNC_POLARITY_MASK (0x20000UL)
#define LVB_CONTROL_DI1_VSYNC_POLARITY_SHIFT (17U)
#define LVB_CONTROL_DI1_VSYNC_POLARITY_SET(x) (((uint32_t)(x) << LVB_CONTROL_DI1_VSYNC_POLARITY_SHIFT) & LVB_CONTROL_DI1_VSYNC_POLARITY_MASK)
#define LVB_CONTROL_DI1_VSYNC_POLARITY_GET(x) (((uint32_t)(x) & LVB_CONTROL_DI1_VSYNC_POLARITY_MASK) >> LVB_CONTROL_DI1_VSYNC_POLARITY_SHIFT)
 ...
 * 0: active high
 */
#define LVB_CONTROL_DI0_VSYNC_POLARITY_MASK (0x10000UL)
#define LVB_CONTROL_DI0_VSYNC_POLARITY_SHIFT (16U)
#define LVB_CONTROL_DI0_VSYNC_POLARITY_SET(x) (((uint32_t)(x) << LVB_CONTROL_DI0_VSYNC_POLARITY_SHIFT) & LVB_CONTROL_DI0_VSYNC_POLARITY_MASK)
#define LVB_CONTROL_DI0_VSYNC_POLARITY_GET(x) (((uint32_t)(x) & LVB_CONTROL_DI0_VSYNC_POLARITY_MASK) >> LVB_CONTROL_DI0_VSYNC_POLARITY_SHIFT)
 ...
 */
#define LVB_CONTROL_LVDS_TXCLK_SHIFT_MASK (0x700U)
#define LVB_CONTROL_LVDS_TXCLK_SHIFT_SHIFT (8U)
#define LVB_CONTROL_LVDS_TXCLK_SHIFT_SET(x) (((uint32_t)(x) << LVB_CONTROL_LVDS_TXCLK_SHIFT_SHIFT) & LVB_CONTROL_LVDS_TXCLK_SHIFT_MASK)
#define LVB_CONTROL_LVDS_TXCLK_SHIFT_GET(x) (((uint32_t)(x) & LVB_CONTROL_LVDS_TXCLK_SHIFT_MASK) >> LVB_CONTROL_LVDS_TXCLK_SHIFT_SHIFT)
 ...
 * 0: SPWG standard
 */
#define LVB_CONTROL_CH1_BIT_MAPPING_MASK (0x80U)
#define LVB_CONTROL_CH1_BIT_MAPPING_SHIFT (7U)
#define LVB_CONTROL_CH1_BIT_MAPPING_SET(x) (((uint32_t)(x) << LVB_CONTROL_CH1_BIT_MAPPING_SHIFT) & LVB_CONTROL_CH1_BIT_MAPPING_MASK)
#define LVB_CONTROL_CH1_BIT_MAPPING_GET(x) (((uint32_t)(x) & LVB_CONTROL_CH1_BIT_MAPPING_MASK) >> LVB_CONTROL_CH1_BIT_MAPPING_SHIFT)
 ...
 * 0: SPWG standard
 */
#define LVB_CONTROL_CH0_BIT_MAPPING_MASK (0x20U)
#define LVB_CONTROL_CH0_BIT_MAPPING_SHIFT (5U)
#define LVB_CONTROL_CH0_BIT_MAPPING_SET(x) (((uint32_t)(x) << LVB_CONTROL_CH0_BIT_MAPPING_SHIFT) & LVB_CONTROL_CH0_BIT_MAPPING_MASK)
#define LVB_CONTROL_CH0_BIT_MAPPING_GET(x) (((uint32_t)(x) & LVB_CONTROL_CH0_BIT_MAPPING_MASK) >> LVB_CONTROL_CH0_BIT_MAPPING_SHIFT)
 ...
 * 0: select DI 0
 */
#define LVB_CONTROL_CH1_SEL_MASK (0x8U)
#define LVB_CONTROL_CH1_SEL_SHIFT (3U)
#define LVB_CONTROL_CH1_SEL_SET(x) (((uint32_t)(x) << LVB_CONTROL_CH1_SEL_SHIFT) & LVB_CONTROL_CH1_SEL_MASK)
#define LVB_CONTROL_CH1_SEL_GET(x) (((uint32_t)(x) & LVB_CONTROL_CH1_SEL_MASK) >> LVB_CONTROL_CH1_SEL_SHIFT)
 ...
 * 0: disable
 */
#define LVB_CONTROL_CH1_EN_MASK (0x4U)
#define LVB_CONTROL_CH1_EN_SHIFT (2U)
#define LVB_CONTROL_CH1_EN_SET(x) (((uint32_t)(x) << LVB_CONTROL_CH1_EN_SHIFT) & LVB_CONTROL_CH1_EN_MASK)
#define LVB_CONTROL_CH1_EN_GET(x) (((uint32_t)(x) & LVB_CONTROL_CH1_EN_MASK) >> LVB_CONTROL_CH1_EN_SHIFT)
 ...
 * 0: select DI 0
 */
#define LVB_CONTROL_CH0_SEL_MASK (0x2U)
#define LVB_CONTROL_CH0_SEL_SHIFT (1U)
#define LVB_CONTROL_CH0_SEL_SET(x) (((uint32_t)(x) << LVB_CONTROL_CH0_SEL_SHIFT) & LVB_CONTROL_CH0_SEL_MASK)
#define LVB_CONTROL_CH0_SEL_GET(x) (((uint32_t)(x) & LVB_CONTROL_CH0_SEL_MASK) >> LVB_CONTROL_CH0_SEL_SHIFT)
 ...
 * 0: disable
 */
#define LVB_CONTROL_CH0_EN_MASK (0x1U)
#define LVB_CONTROL_CH0_EN_SHIFT (0U)
#define LVB_CONTROL_CH0_EN_SET(x) (((uint32_t)(x) << LVB_CONTROL_CH0_EN_SHIFT) & LVB_CONTROL_CH0_EN_MASK)
#define LVB_CONTROL_CH0_EN_GET(x) (((uint32_t)(x) & LVB_CONTROL_CH0_EN_MASK) >> LVB_CONTROL_CH0_EN_SHIFT)
 ...
 */
#define LVB_PHY_STATUS_LVDS1_TX_PHY_PLL_LOCK_MASK (0x2U)
#define LVB_PHY_STATUS_LVDS1_TX_PHY_PLL_LOCK_SHIFT (1U)
#define LVB_PHY_STATUS_LVDS1_TX_PHY_PLL_LOCK_GET(x) (((uint32_t)(x) & LVB_PHY_STATUS_LVDS1_TX_PHY_PLL_LOCK_MASK) >> LVB_PHY_STATUS_LVDS1_TX_PHY_PLL_LOCK_SHIFT)
 ...
 */
#define LVB_PHY_STATUS_LVDS0_TX_PHY_PLL_LOCK_MASK (0x1U)
#define LVB_PHY_STATUS_LVDS0_TX_PHY_PLL_LOCK_SHIFT (0U)
#define LVB_PHY_STATUS_LVDS0_TX_PHY_PLL_LOCK_GET(x) (((uint32_t)(x) & LVB_PHY_STATUS_LVDS0_TX_PHY_PLL_LOCK_MASK) >> LVB_PHY_STATUS_LVDS0_TX_PHY_PLL_LOCK_SHIFT)
...
#define LVB_CONTROL_CTRL (0UL)

/* PHY_STATUS register group index macro definition */
#define LVB_PHY_STATUS_PHY_STAT (0UL)
