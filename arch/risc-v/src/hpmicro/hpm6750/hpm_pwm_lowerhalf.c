...
#    error "The maximum number of HPM6750 PWM channels is 8!"
#  endif
#endif
...
static int hpm_pwm_setup(struct pwm_lowerhalf_s *dev)
{
  ...
  UNUSED(i);
  priv->pwm_freq = 0; 
  ret = hpm6750_init_pwm_pins(priv->pwm_port);
