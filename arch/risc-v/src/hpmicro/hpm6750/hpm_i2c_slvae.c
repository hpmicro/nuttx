/****************************************************************************
 * arch/risc-v/src/hpmicro/hpm6750/hpm_i2c_slave.c
 *
...
#if defined(CONFIG_HPM6750_I2C0_SLAVE) || defined(CONFIG_HPM6750_I2C1_SLAVE) || \
    defined(CONFIG_HPM6750_I2C2_SLAVE) || defined(CONFIG_HPM6750_I2C3_SLAVE)
...
static int hpm_i2c_slave_init(hpm6750_i2c_slave_t  *dev);
...
#ifdef CONFIG_HPM6750_I2C0_SLAVE

hpm6750_i2c_slave_t i2c0_slave_dev =
{
...
#ifdef CONFIG_HPM6750_I2C1_SLAVE

hpm6750_i2c_slave_t i2c1_slave_dev =
{
  .dev.ops                         = &i2c_slaveops, /* Slave operations */
...
#ifdef CONFIG_HPM6750_I2C2_SLAVE

hpm6750_i2c_slave_t i2c2_slave_dev =
{
  .dev.ops                         = &i2c_slaveops, /* Slave operations */
...
#ifdef CONFIG_HPM6750_I2C3_SLAVE

hpm6750_i2c_slave_t i2c3_slave_dev =
{
  .dev.ops                         = &i2c_slaveops, /* Slave operations */
...
{
  hpm6750_i2c_slave_t *priv = (hpm6750_i2c_slave_t *)arg;
...
static void hpm_i2c_rtxint(struct i2c_slave_s  *dev, bool enable)
{
  hpm6750_i2c_slave_t *priv = (hpm6750_i2c_slave_t *) dev;
  if (enable) 
    {
                            ...
                            i2c_slave_callback_t *callback)
{
  ...
  if (hpm6750_i2cbus_pins_initialize(port) < 0)
    {
      return NULL;
    }
