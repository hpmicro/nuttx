/****************************************************************************
 * arch/arm/src/hpmicro/hpm6750/hpm_can_sock.c
 *
...
#include "hpm_can.h"
    ...
    (defined CONFIG_NET_CAN || defined CONFIG_NET_CANFD) 
...
#  ifdef CONFIG_HPM6750_CAN0_USER_SET_TINING
      ...
      priv->can_config.can_timing.num_seg1         = CONFIG_HPM6750_CAN0_NUM_SEG1;
      priv->can_config.can_timing.num_seg2         = CONFIG_HPM6750_CAN0_NUM_SEG2;
      priv->can_config.can_timing.num_sjw          = CONFIG_HPM6750_CAN0_NUM_SJW;
      priv->can_config.can_timing.prescaler        = CONFIG_HPM6750_CAN0_PRESCALER;
      priv->can_config.canfd_timing.num_seg1       = CONFIG_HPM6750_CAN0_FD_NUM_SEG1;
      priv->can_config.canfd_timing.num_seg2       = CONFIG_HPM6750_CAN0_FD_NUM_SEG2;
      priv->can_config.canfd_timing.num_sjw        = CONFIG_HPM6750_CAN0_FD_NUM_SJW;
      priv->can_config.canfd_timing.prescaler      = CONFIG_HPM6750_CAN0_FD_PRESCALER;
#  else
      priv->can_config.can20_samplepoint_min       = CONFIG_HPM6750_CAN0_MIN_SAMPLEPOINT;
      priv->can_config.can20_samplepoint_max       = CONFIG_HPM6750_CAN0_MAX_SAMPLEPOINT;
      priv->can_config.baudrate                    = CONFIG_HPM6750_CAN0_BAUDRATE;

#    ifdef CONFIG_NET_CAN_CANFD
      priv->can_config.canfd_samplepoint_min       = CONFIG_HPM6750_CAN0_FD_MIN_SAMPLEPOINT;
      priv->can_config.canfd_samplepoint_max       = CONFIG_HPM6750_CAN0_FD_MAX_SAMPLEPOINT;
      priv->can_config.enable_canfd                = true;
      priv->can_config.baudrate_fd                 = CONFIG_HPM6750_CAN0_FD_BAUDRATE;
#    endif

#  endif
      priv->can_config.enable_can_fd_iso_mode     = CONFIG_HPM6750_CAN0_FD_ISO_MODE;
      priv->can_config.mode                       = CONFIG_HPM6750_CAN0_MODE;
    }
  else
#endif
#ifdef CONFIG_HPM6750_CAN1
...
#  ifdef CONFIG_HPM6750_CAN1_USER_SET_TINING
      ...
      priv->can_config.can_timing.num_seg1         = CONFIG_HPM6750_CAN1_NUM_SEG1;
      priv->can_config.can_timing.num_seg2         = CONFIG_HPM6750_CAN1_NUM_SEG2;
      priv->can_config.can_timing.num_sjw          = CONFIG_HPM6750_CAN1_NUM_SJW;
      priv->can_config.can_timing.prescaler        = CONFIG_HPM6750_CAN1_PRESCALER;
      priv->can_config.canfd_timing.num_seg1       = CONFIG_HPM6750_CAN1_FD_NUM_SEG1;
      priv->can_config.canfd_timing.num_seg2       = CONFIG_HPM6750_CAN1_FD_NUM_SEG2;
      priv->can_config.canfd_timing.num_sjw        = CONFIG_HPM6750_CAN1_FD_NUM_SJW;
      priv->can_config.canfd_timing.prescaler      = CONFIG_HPM6750_CAN1_FD_PRESCALER;
#  else
      priv->can_config.can20_samplepoint_min       = CONFIG_HPM6750_CAN1_MIN_SAMPLEPOINT;
      priv->can_config.can20_samplepoint_max       = CONFIG_HPM6750_CAN1_MAX_SAMPLEPOINT;
      priv->can_config.baudrate                    = CONFIG_HPM6750_CAN1_BAUDRATE;

#    ifdef CONFIG_NET_CAN_CANFD
      priv->can_config.canfd_samplepoint_min       = CONFIG_HPM6750_CAN1_FD_MIN_SAMPLEPOINT;
      priv->can_config.canfd_samplepoint_max       = CONFIG_HPM6750_CAN1_FD_MAX_SAMPLEPOINT;
      priv->can_config.enable_canfd                = true;
      priv->can_config.baudrate_fd                 = CONFIG_HPM6750_CAN1_FD_BAUDRATE;
#    endif

#  endif
      priv->can_config.enable_can_fd_iso_mode     = CONFIG_HPM6750_CAN1_FD_ISO_MODE;
      priv->can_config.mode                       = CONFIG_HPM6750_CAN1_MODE;
    }
  else
#endif
#ifdef CONFIG_HPM6750_CAN2
...
#  ifdef CONFIG_HPM6750_CAN2_USER_SET_TINING
      ...
      priv->can_config.can_timing.num_seg1         = CONFIG_HPM6750_CAN2_NUM_SEG1;
      priv->can_config.can_timing.num_seg2         = CONFIG_HPM6750_CAN2_NUM_SEG2;
      priv->can_config.can_timing.num_sjw          = CONFIG_HPM6750_CAN2_NUM_SJW;
      priv->can_config.can_timing.prescaler        = CONFIG_HPM6750_CAN2_PRESCALER;
      priv->can_config.canfd_timing.num_seg1       = CONFIG_HPM6750_CAN2_FD_NUM_SEG1;
      priv->can_config.canfd_timing.num_seg2       = CONFIG_HPM6750_CAN2_FD_NUM_SEG2;
      priv->can_config.canfd_timing.num_sjw        = CONFIG_HPM6750_CAN2_FD_NUM_SJW;
      priv->can_config.canfd_timing.prescaler      = CONFIG_HPM6750_CAN2_FD_PRESCALER;
#  else
      priv->can_config.can20_samplepoint_min       = CONFIG_HPM6750_CAN2_MIN_SAMPLEPOINT;
      priv->can_config.can20_samplepoint_max       = CONFIG_HPM6750_CAN2_MAX_SAMPLEPOINT;
      priv->can_config.baudrate                    = CONFIG_HPM6750_CAN2_BAUDRATE;

#    ifdef CONFIG_NET_CAN_CANFD
      priv->can_config.canfd_samplepoint_min       = CONFIG_HPM6750_CAN2_FD_MIN_SAMPLEPOINT;
      priv->can_config.canfd_samplepoint_max       = CONFIG_HPM6750_CAN2_FD_MAX_SAMPLEPOINT;
      priv->can_config.enable_canfd                = true;
      priv->can_config.baudrate_fd                 = CONFIG_HPM6750_CAN2_FD_BAUDRATE;
#    endif

#  endif
      priv->can_config.enable_can_fd_iso_mode     = CONFIG_HPM6750_CAN2_FD_ISO_MODE;
      priv->can_config.mode                       = CONFIG_HPM6750_CAN2_MODE;
    }
  else
#endif
#ifdef CONFIG_HPM6750_CAN3
...
#  ifdef CONFIG_HPM6750_CAN3_USER_SET_TINING
      ...
      priv->can_config.can_timing.num_seg1         = CONFIG_HPM6750_CAN3_NUM_SEG1;
      priv->can_config.can_timing.num_seg2         = CONFIG_HPM6750_CAN3_NUM_SEG2;
      priv->can_config.can_timing.num_sjw          = CONFIG_HPM6750_CAN3_NUM_SJW;
      priv->can_config.can_timing.prescaler        = CONFIG_HPM6750_CAN3_PRESCALER;
      priv->can_config.canfd_timing.num_seg1       = CONFIG_HPM6750_CAN3_FD_NUM_SEG1;
      priv->can_config.canfd_timing.num_seg2       = CONFIG_HPM6750_CAN3_FD_NUM_SEG2;
      priv->can_config.canfd_timing.num_sjw        = CONFIG_HPM6750_CAN3_FD_NUM_SJW;
      priv->can_config.canfd_timing.prescaler      = CONFIG_HPM6750_CAN3_FD_PRESCALER;
#  else
      priv->can_config.can20_samplepoint_min       = CONFIG_HPM6750_CAN3_MIN_SAMPLEPOINT;
      priv->can_config.can20_samplepoint_max       = CONFIG_HPM6750_CAN3_MAX_SAMPLEPOINT;
      priv->can_config.baudrate                    = CONFIG_HPM6750_CAN3_BAUDRATE;

#    ifdef CONFIG_NET_CAN_CANFD
      priv->can_config.canfd_samplepoint_min       = CONFIG_HPM6750_CAN3_FD_MIN_SAMPLEPOINT;
      priv->can_config.canfd_samplepoint_max       = CONFIG_HPM6750_CAN3_FD_MAX_SAMPLEPOINT;
      priv->can_config.enable_canfd                = true;
      priv->can_config.baudrate_fd                 = CONFIG_HPM6750_CAN3_FD_BAUDRATE;
#    endif

#  endif
      priv->can_config.enable_can_fd_iso_mode     = CONFIG_HPM6750_CAN3_FD_ISO_MODE;
      priv->can_config.mode                       = CONFIG_HPM6750_CAN3_MODE;
    }
  else
#endif
    {
